...
b11 = Book.create(title: "Robopocalypse", author: "Daniel H. Wilson", description: "Robots do bad things probably.", publisher: "Doubleday", weeks_on_list: 14, rank_this_week: 14)
b12 = Book.create(title: "Zen and the Art of Motorcycle Maintenance: An Inquiry into Values", author: "Robert M Pirsig", description: "Profound", publisher: "HarperTorch", weeks_on_list: 96, rank_this_week: 13)
...
Review.create(comment: "Robots are cuddly creatures and should not be libelled in this obtuse fashion!", author: "Cherise", book_id: b11.id)
